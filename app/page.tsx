    ...
    />
        ...
        <div className="relative max-w-6xl mx-auto w-full pt-36">
          <div className="flex items-center gap-2 mb-10">
            ...
            <span className="font-mono text-xs text-primary-foreground tracking-widest">
              ~/portfolio — zsh
            </span>
          ...
          <p className="text-primary-foreground/65 max-w-3xl mb-12 leading-relaxed text-base md:text-lg">
            I build robust, scalable web applications — from pixel-perfect React
            interfaces to battle-tested Node.js APIs. Obsessed with clean
            architecture, developer experience, and shipping things that work.
          </p>

          <div className="flex flex-wrap gap-4 mb-24">
            <Link href="/projects" className="font-mono text-sm uppercase tracking-widest px-6 py-4 bg-background text-primary hover:bg-primary-foreground/90 transition-colors font-semibold flex items-center gap-2"
            >
              View Projects
